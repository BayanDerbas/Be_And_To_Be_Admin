  ...
  Widget build(BuildContext context) {
    ...
    final rowContent = Row(
      children: [
        ...
        rc.isMobile ? SizedBox(width: 8) : SizedBox(width: 12),
        rc.isMobile
            ? SizedBox(width: 80, child: Center(child: Text('عدد العناصر', style: TextStyle(color: AppColors.white, fontWeight: FontWeight.bold))))
            : Flexible(flex: 2, fit: FlexFit.tight, child: Center(child: Text('عدد العناصر', style: TextStyle(color: AppColors.white, fontWeight: FontWeight.bold)))),
        rc.isMobile ? SizedBox(width: 8) : SizedBox(width: 12),
        rc.isMobile
            ? SizedBox(width: 80, child: Center(child: Text('المجموع', style: TextStyle(color: AppColors.white, fontWeight: FontWeight.bold))))
            : Flexible(flex: 2, fit: FlexFit.tight, child: Center(child: Text('المجموع', style: TextStyle(color: AppColors.white, fontWeight: FontWeight.bold)))),
        rc.isMobile ? SizedBox(width: 8) : SizedBox(width: 12),
        rc.isMobile
